...
<p style="text-align:center">
    <img width="356px" alt="Demo" src="https://raw.githubusercontent.com/vaetas/animated_list/master/assets/demo.gif"/>
</p>

Click [here](https://github.com/vaetas/animated_list/blob/master/example/lib/ui/) to view the full example.
...
```
> For a more in depth example click [here](https://github.com/vaetas/animated_list/blob/master/example/lib/ui/lang_page.dart).
